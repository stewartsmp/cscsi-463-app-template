...
home_b = Button(frame,bg='white',relief='flat')
set_b = Button(frame,bg='white',relief='flat')
ring_b = Button(frame,bg='white',relief='flat')
...
wrapper1 = Frame(root, bg = "blue", width = 250, height=root.winfo_height())
wrapper1.grid(row = 0, column = 1)
